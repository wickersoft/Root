...
public class FireworkEffectPlayer {
    ...
    static {
        try {
            Class.forName("net.minecraft.server.v1_11_R1.EntityFireworks");
            nmsDetected = true;
    ...
    public static void playFirework(Location location, FireworkEffect... effects) {
        ...
        CustomEntityFirework_1_11_R1 firework = new CustomEntityFirework_1_11_R1(location, nmsIs);
        firework.perform();
    }
    ...
    private static class CustomEntityFirework_1_11_R1 extends EntityFireworks {

        private final Player[] players = new Player[]{};
        private final Location location;
        private boolean gone = false;

        protected CustomEntityFirework_1_11_R1(Location loc, net.minecraft.server.v1_11_R1.ItemStack metaContainer) {
